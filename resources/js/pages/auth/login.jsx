        ...
        <>
            ...
            <main className="min-h-screen bg-background text-foreground px-4 py-10">
                <section className="mx-auto w-full max-w-md overflow-hidden rounded-[2rem] border border-border bg-card/90 p-8 shadow-[0_30px_80px_-40px_rgba(0,0,0,0.35)] backdrop-blur-sm">
                    ...
                    <h1 className="mt-8 text-4xl font-black tracking-tight text-foreground">Welcome back</h1>

                    <p className="mt-3 text-sm leading-6 text-muted-foreground">
                        Log in to view your profile and follow your orders.
                    </p>
                    ...
                    <p className="mt-7 text-center text-sm text-muted-foreground">
                        New here?{' '}
                        <Link href="/register" className="font-semibold text-foreground underline-offset-2 hover:text-white">
                            Create an account
                        </Link>
                    </p>
                </section>
